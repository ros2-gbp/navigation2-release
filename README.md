## navigation2 (jazzy) - 1.3.13-1

The packages in the `navigation2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release navigation2 --track jazzy --rosdistro jazzy` on `Fri, 21 Aug 2026 22:33:35 -0000`
...
## navigation2 (lyrical) - 1.5.1-1

The packages in the `navigation2` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release navigation2 --track lyrical --rosdistro lyrical` on `Wed, 12 Aug 2026 01:00:05 -0000`
...
## navigation2 (lyrical) - 1.5.0-1

The packages in the `navigation2` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release navigation2 --track lyrical --rosdistro lyrical --edit` on `Tue, 04 Aug 2026 21:48:56 -0000`
...
## navigation2 (jazzy) - 1.3.12-1

The packages in the `navigation2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release navigation2 --rosdistro jazzy --track jazzy` on `Wed, 29 Apr 2026 23:41:21 -0000`
...
## navigation2 (jazzy) - 1.3.11-1

The packages in the `navigation2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release navigation2 --rosdistro jazzy --track jazzy` on `Sat, 24 Jan 2026 03:30:03 -0000`
...
## navigation2 (humble) - 1.1.20-1

The packages in the `navigation2` repository were released into the `humble` distro by running `/usr/bin/bloom-release navigation2 --ros-distro humble --track humble` on `Mon, 17 Nov 2025 18:02:06 -0000`
...
## navigation2 (jazzy) - 1.3.10-1

The packages in the `navigation2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release navigation2 --track jazzy --rosdistro jazzy` on `Thu, 23 Oct 2025 18:00:49 -0000`
...
## navigation2 (kilted) - 1.4.2-1

The packages in the `navigation2` repository were released into the `kilted` distro by running `/usr/bin/bloom-release navigation2 --track kilted --rosdistro kilted` on `Sat, 20 Sep 2025 00:26:56 -0000`
...
The packages in the `navigation2` repository were released into the `dashing` distro by running `/usr/bin/bloom-release navigation2 --track dashing --rosdistro dashing` on `Fri, 02 Aug 2019 04:46:55 -0000`
...
## navigation2 (dashing) - 0.2.2-1

The packages in the `navigation2` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --rosdistro dashing --track dashing navigation2` on `Tue, 16 Jul 2019 22:54:12 -0000`
...
## navigation2 (dashing) - 0.2.1-1

The packages in the `navigation2` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --rosdistro dashing --track dashing navigation2` on `Tue, 16 Jul 2019 03:44:01 -0000`
...
## navigation2 (crystal) - 0.1.7-0

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2 --edit` on `Wed, 13 Mar 2019 18:13:19 -0000`
...
## navigation2 (crystal) - 0.1.6-2

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2 --edit` on `Wed, 13 Mar 2019 02:21:35 -0000`
...
## navigation2 (crystal) - 0.1.6-1

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2 --edit` on `Wed, 13 Mar 2019 02:14:24 -0000`
...
## navigation2 (crystal) - 0.1.4-0

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2` on `Wed, 12 Dec 2018 00:21:19 -0000`
...
## navigation2 (crystal) - 0.1.3-0

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2` on `Mon, 10 Dec 2018 22:45:01 -0000`
...
## navigation2 (crystal) - 0.1.2-0

The packages in the `navigation2` repository were released into the `crystal` distro by running `/usr/bin/bloom-release --rosdistro crystal --track crystal navigation2` on `Fri, 07 Dec 2018 00:04:23 -0000`
...
## navigation2 (bouncy) - 0.1.0-0

The packages in the `navigation2` repository were released into the `bouncy` distro by running `/usr/bin/bloom-release --rosdistro bouncy --track bouncy navigation2 --edit` on `Tue, 30 Oct 2018 19:30:23 -0000`
