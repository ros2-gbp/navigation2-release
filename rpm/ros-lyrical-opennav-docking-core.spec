...
%global pkg_name opennav_docking_core
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-opennav-docking-core
Version:        1.5.2
Release:        2%{?dist}
...
%changelog
* Wed Sep 16 2026 Steve Macenski <steve@opennav.org> - 1.5.2-2
- Autogenerated by Bloom

* Wed Aug 12 2026 Steve Macenski <steve@opennav.org> - 1.5.1-1
- Autogenerated by Bloom

* Tue Aug 04 2026 Steve Macenski <steve@opennav.org> - 1.5.0-1
- Autogenerated by Bloom
