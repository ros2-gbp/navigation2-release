...
%global pkg_name nav2_collision_monitor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-nav2-collision-monitor
Version:        1.5.2
Release:        2%{?dist}
...
%changelog
* Wed Sep 16 2026 Alexey Merzlyakov <alexey.merzlyakov@samsung.com> - 1.5.2-2
- Autogenerated by Bloom

* Wed Aug 12 2026 Alexey Merzlyakov <alexey.merzlyakov@samsung.com> - 1.5.1-1
- Autogenerated by Bloom

* Tue Aug 04 2026 Alexey Merzlyakov <alexey.merzlyakov@samsung.com> - 1.5.0-1
- Autogenerated by Bloom
